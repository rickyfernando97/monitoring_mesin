...
class App extends MY_Controller {
    ...
    function get_detail_machine(){
        ...
        $time_mulai = (int) (isset($machine_kegiatan) && isset($machine_kegiatan->time_mulai)) ?
            $machine_kegiatan->time_mulai : 0;
        $duration = (int) (isset($machine_kegiatan) && isset($machine_kegiatan->duration)) ?
            $machine_kegiatan->duration : 0; // minutes
        $total_downtime = (int) (isset($machine_kegiatan) && isset($machine_kegiatan->total_downtime)) ?
            $machine_kegiatan->total_downtime : 0; // second
